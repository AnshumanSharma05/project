...
const InputC =()=>{
	return (
		<div > 
		    ...
		    <div>
		    <fieldset>
		        <legend for="330088867">Education needs for job as Identified by Sec/ Dept/Div Head</legend>
		        <div class="form-group">
		            <textarea id="1802716399" name="entry.1802716399" class="form-control" ></textarea>
		        </div>
		    </fieldset>
		    </div>
		        ...
		        <div class="form-group f3">
		            <div>
		                ...
		                <label className="radio-inline">
		                    <input type="radio" name="entry.1333258518" value="5" />
		                    5
		                </label>
		                <label className="radio-inline">
		                    <input type="radio" name="entry.1333258518" value="4"/>
		                    4
		                </label>
		                <label className="radio-inline">
		                    <input type="radio" name="entry.1333258518" value="3" />
		                    3
		                </label>
		                <label className="radio-inline">
		                    <input type="radio" name="entry.1333258518" value="2" />
		                    2
		                </label>
		                <label className="radio-inline">
		                    <input type="radio" name="entry.1333258518" value="1" />
		                    1
		                </label>
		            </div>
		            <div>
		    ...
		    <input type="hidden" name="fbzx" value="1598649009555852854" />
